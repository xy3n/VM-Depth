...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        if opt.eval_teacher:
            ...
            encoder_class = networks.ResnetEncoderMatching_FusedCostVolume_VMamba  
        ...
        if opt.eval_split == 'cityscapes':
            dataset = datasets.CityscapesEvalDataset('leftImg8bit_sequence_trainvaltest', filenames,
                                                     HEIGHT, WIDTH,
                                                     frames_to_load, 4,
                                                     is_train=False)
