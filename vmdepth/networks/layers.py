...
class Project3D_V2(nn.Module):
 
    def __init__(self, batch_size, height, width, eps=1e-7):
        super(Project3D_V2, self).__init__()
    ...
    def forward(self, points, K, T):
        ...
        cam_points_3D = torch.matmul(T, points) if T is not None else points # cam_points_3D 是参考帧相机坐标下的三维坐标点
