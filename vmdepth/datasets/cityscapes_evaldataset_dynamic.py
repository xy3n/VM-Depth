...
class CityscapesEvalDataset(MonoDataset):
    ...
    def get_doj_mask(self, city, frame_name, side, do_flip):
        ...
        frame = int(frame)
        mask = np.load('cityscapes_data_path/val_mask/{}_{}_{}.npy'.format(city, seq, frame))
        maskm1 = np.load('cityscapes_data_path/val_mask/{}_{}_{}-1.npy'.format(city, seq, frame))
        maskp1 = np.load('cityscapes_data_path/val_mask/{}_{}_{}+1.npy'.format(city, seq, frame))
